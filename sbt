...
# copied into blobstore in order to get the perf-tests to run in the MPL as it only has SBT 0.12 
...
declare -r default_jvm_opts="-Xms512m -Xmx1536m -Xss2m -XX:MaxPermSize=384m $jit_opts $cms_opts"
